"""
copy and modified from https://github1s.com/HRNet/HRNet-Semantic-Segmentation/blob/HEAD/lib/models/seg_hrnet.py
"""
...
from Module.edge_refine.bam import BAM
from Module.edge_refine.bfm import BFM
...
# modified in_channels,n_classes
class HighResolutionNet(nn.Module):

    def __init__(self, config, in_channels=4, n_classes=1, **kwargs):
        ...
        # edge branch,新增
        self.edge_branch_cfg = extra['EDGE_BRANCH']
        if self.edge_branch_cfg['EDGE_NAME']:
            edge_block_name = self.edge_branch_cfg['EDGE_NAME']
...
if __name__ == '__main__':
    ...
    cfg = update_config(default_config, r'./config/edge_seg_hrnet.yaml')
